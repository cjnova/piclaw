...
export interface DashboardWidgetBlock extends Record<string, unknown> {
...
function buildDashboardWidgetHtml(): string {
...
export function createDashboardWidgetBlock(widgetId = createUuid("widget")): DashboardWidgetBlock {
  return {
    type: "generated_widget",
    widget_id: widgetId,
