...
function buildWorkspaceMemoryBootstrap() {
    ...
    lines.push("Use MEMORY.md as the durable startup index, notes/index.md as the map of structured notes, open linked day/topic files only when you need more detail, and use search_workspace for note lookups.", "When doing Dream-style maintenance, prefer rough searches from known suspicions over exhaustive transcript reading.", "Keep this aligned with the workspace note hierarchy rather than inventing a parallel memory source.");
    return lines.join("\n\n");
}
export const workspaceMemoryBootstrap = (pi) => {
