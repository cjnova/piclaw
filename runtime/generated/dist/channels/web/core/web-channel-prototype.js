...
export function installWebChannelPrototype(target, defaults) {
    Object.defineProperties(target, {
        ...
        handleAgentOobeComplete: {
            configurable: true,
            writable: true,
            value: withHttpSurface(async (service, req) => await service.handleAgentOobeComplete(req)),
        },
        ...
        handleAgentQueueReorder: {
            configurable: true,
            writable: true,
            value: withHttpSurface(async (service, req) => await service.handleAgentQueueReorder(req)),
        },
        handleAgentModels: {
            configurable: true,
            writable: true,
