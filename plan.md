...
- [ ] **Refactor `src/channels/web.ts` into narrower services**
  ...
  - Pending: split remaining `web.ts` orchestration around residual state adapters and endpoint wrappers (file now reduced to ~625 LOC, approaching the 600 LOC architecture bar).
