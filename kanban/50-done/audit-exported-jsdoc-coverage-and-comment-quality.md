...
- Remaining adjacent documented-gap follow-up retargeted to `kanban/10-next/close-web-vnc-session-service-jsdoc-gaps.md`.
...
- Split explicit follow-up for remaining larger adjacent gaps outside this pass scope: `kanban/10-next/close-web-workspace-media-posts-jsdoc-gaps.md`.
