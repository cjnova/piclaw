...
- Split larger/riskier duplication follow-up: `workitems/10-next/consolidate-web-channel-test-bootstrap-fixtures.md`.
- Validation on `main`:
...
- `workitems/10-next/split-agentpool-god-class.md`
- `workitems/10-next/consolidate-web-channel-test-bootstrap-fixtures.md`
