...
- `workitems/10-next/baseline-quality-and-deterministic-test-sweep.md`
- `workitems/10-next/fuzz-agent-control-and-command-routing.md`
- `workitems/10-next/fuzz-web-control-plane-and-extension-hooks.md`
- `workitems/10-next/validate-queue-session-threading-invariants-and-db-replay.md`
