...
### 2026-03-27
- Created by splitting the remaining scope out of `workitems/50-done/extract-typed-config-objects.md` after the extraction/object-grouping milestone landed on `main`.
...
- Remaining broader web-surface consumers were split explicitly into `workitems/10-next/finish-web-live-identity-getter-adoption.md` instead of widening this slice into a larger web-channel refactor.
...
- `workitems/10-next/finish-web-live-identity-getter-adoption.md`
